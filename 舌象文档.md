...
7. health_document_xinlv/health_document_bushu/health_document_shexiang，http://47.104.97.44:8080/health_document_shexiang (health_document_xinlv/health_document_bushu)

   - get 获取某一名用户的该类型健康档案，query参数tel
   - post 新增，body参数tel,words
   - delete 删除，参数hdo_id
