...
1. post http://47.104.97.44:8080/post
   ...
   - get 获取所有post列表 
   - post 新增，参数title，plate_id,sub_title,post_type,file(可选,类型为文件)
...
- post 新增，参数title
   - put 更新，参数id，title
- delete 删除，参数id
4. 定向查找帖子post http://47.104.97.44:8080/findpost ,类型为post，参数post_id
5. 定向查找某个帖子的所有评论opinion http://47.104.97.44:8080/findop ,类型为post，参数为post_id
